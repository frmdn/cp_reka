	...
	<div class="page-content-wrap">
		...
		<div class="row">
			<div class="col-md-8 mx-auto">
             <h4><span class=""></span>Create page</h4>
         </div>
                    ...
                    <form class="form-horizontal" action="{{ route('page.store') }}" method="post">
                     ...
                     <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Create</strong> Data</h3>
                            <ul class="panel-controls">
                                <li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
                            </ul>
                        </div>
                        <div class="panel-body">
                           <p>Silahkan melakukan input data agar data dapat tersimpan dengan baik.</p>
                       </div>
                       <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <select name="halaman" class="form-control select">
                                    ...
                                    <option value="2">Header Sub</option>
                                    <option value="3">Halaman Sub</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <select name="sub_page" class="form-control select">
                                    <option value="0">Pilih Pages</option>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Posting</label>
                            <div class="col-md-6 col-xs-12">
                                <select name="post_id" class="form-control select" required>
                                 <option value="0">Pilih Posting</option>
